...
case $answer in
	...
	j*|J*|y*|Y*) #buildcase on answer yes
		...
		make -j$MAKETHREADS -l$MAXLOAD GLUON_TARGET=bcm27xx-bcm2708 $BRANCH $AUTOUPDATER_ENABLED DEFAULT_GLUON_RELEASE=$VERSION $BROKEN $LOGLEVEL $BUILDLOG GLUON_AUTOREMOVE=1
		make -j$MAKETHREADS -l$MAXLOAD GLUON_TARGET=bcm27xx-bcm2709 $BRANCH $AUTOUPDATER_ENABLED DEFAULT_GLUON_RELEASE=$VERSION $BROKEN $LOGLEVEL $BUILDLOG GLUON_AUTOREMOVE=1
#broken_2023.2	make -j$MAKETHREADS -l$MAXLOAD GLUON_TARGET=bcm27xx-bcm2710 $BRANCH $AUTOUPDATER_ENABLED DEFAULT_GLUON_RELEASE=$VERSION $BROKEN $LOGLEVEL $BUILDLOG GLUON_AUTOREMOVE=1
#broken_2023.2	make -j$MAKETHREADS -l$MAXLOAD GLUON_TARGET=bcm27xx-bcm2711 $BRANCH $AUTOUPDATER_ENABLED DEFAULT_GLUON_RELEASE=$VERSION $BROKEN $LOGLEVEL $BUILDLOG GLUON_AUTOREMOVE=1
		...
		make -j$MAKETHREADS -l$MAXLOAD GLUON_TARGET=mediatek-filogic $BRANCH $AUTOUPDATER_ENABLED DEFAULT_GLUON_RELEASE=$VERSION $BROKEN $LOGLEVEL $BUILDLOG GLUON_AUTOREMOVE=1
...
#broken_2023.2	make -j$MAKETHREADS -l$MAXLOAD GLUON_TARGET=mvebu-cortexa9 $BRANCH $AUTOUPDATER_ENABLED DEFAULT_GLUON_RELEASE=$VERSION $BROKEN $LOGLEVEL $BUILDLOG GLUON_AUTOREMOVE=1
		...
		make -j$MAKETHREADS -l$MAXLOAD GLUON_TARGET=ramips-mt7621 $BRANCH $AUTOUPDATER_ENABLED DEFAULT_GLUON_RELEASE=$VERSION $BROKEN $LOGLEVEL $BUILDLOG GLUON_AUTOREMOVE=1
